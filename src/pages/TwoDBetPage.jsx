            ...
            <div className="max-w-md mx-auto flex justify-between items-center pt-6 pb-2 px-6 gap-4">
                <div className="flex flex-col items-center">
                    <button 
                        ...
                        className="w-14 h-14 flex items-center justify-center rounded-full bg-white/60 backdrop-blur-md shadow-lg border border-pink-200 hover:scale-105 active:scale-95 transition-all"
                    >
